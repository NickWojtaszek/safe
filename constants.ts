...
export const DATA_SCHEMA: CollectionSchema = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'prior_stentgraft_type', label: 'Typ stentgraftu', type: FieldType.SELECT, options: [{label: 'BEVAR', value: 'bevar'}, {label: 'TEVAR', value: 'tevar'}, {label: 'EVAR', value: 'evar'}, {label: 'IBD', value: 'ibd'}] },
      { id: 'prior_stentgraft_date', label: 'Data zabiegu', type: FieldType.DATE },
      ...
      { id: 'last_stroke_date', label: 'Data ostatniego udaru/TIA', type: FieldType.DATE },
